...
public final class ModPayloads {
    ...
    public static void register(RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToClient(DataDrivenDefinitionSyncPayload.TYPE, DataDrivenDefinitionSyncPayload.STREAM_CODEC, ModPayloads::handleDefinitionSync);
    ...
    private static void handleDefinitionSync(DataDrivenDefinitionSyncPayload payload, IPayloadContext context) {
        context.enqueueWork(payload::applyClientSync);
    }
