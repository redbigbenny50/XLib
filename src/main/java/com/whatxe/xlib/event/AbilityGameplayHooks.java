...
public final class AbilityGameplayHooks {
    ...
    public static void onIncomingDamage(LivingIncomingDamageEvent event) {
        ...
        if (event.getEntity() instanceof LivingEntity target
            ...
            damageAmount.setAmount(DamageModifierProfileApi.applyOutgoing(attackingPlayer, event.getSource(), damageAmount.amount()));
        ...
        if (event.getEntity() instanceof ServerPlayer player) {
            ...
            damageAmount.setAmount(DamageModifierProfileApi.applyIncoming(player, event.getSource(), damageAmount.amount()));
            ...
            DataDrivenTrackedValueRuleApi.dispatchDamageTaken(player, attacker, event.getSource());
        }
    ...
    public static void onDamagePost(LivingDamageEvent.Post event) {
        ...
        DataDrivenTrackedValueRuleApi.dispatchDamageDealt(player, target, source);
    }
    ...
    public static void onLivingDeath(LivingDeathEvent event) {
        ...
        DataDrivenTrackedValueRuleApi.dispatchKill(player, target, event.getSource());
    }
    ...
    public static void onJump(LivingEvent.LivingJumpEvent event) {
        ...
        DataDrivenTrackedValueRuleApi.dispatchJump(player);
    }
    ...
    public static void onBlockBreak(BlockEvent.BreakEvent event) {
        ...
        DataDrivenTrackedValueRuleApi.dispatchBlockBroken(player, event.getState());
    }
    ...
    public static void onPlayerTick(PlayerTickEvent.Post event) {
        ...
        for (EquipmentSlot slot : ArmorSnapshot.ARMOR_SLOTS) {
            ...
            if (!ItemStack.matches(from, to)) {
                ...
                DataDrivenTrackedValueRuleApi.dispatchArmorChanged(player, slot, from, to);
            }
        }
