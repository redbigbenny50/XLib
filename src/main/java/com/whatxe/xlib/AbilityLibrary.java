...
import com.whatxe.xlib.network.DataDrivenDefinitionSyncPayload;
...
public final class AbilityLibrary {
    ...
    public static void bootstrap(IEventBus modEventBus) {
        ...
        EntityClassificationApi.bootstrap();
        ...
        DamageModifierProfileApi.bootstrap();
        DataDrivenDamageModifierProfileApi.bootstrap();
        TrackedValueApi.bootstrap();
        DataDrivenTrackedValueApi.bootstrap();
        DataDrivenTrackedValueRuleApi.bootstrap();
    ...
    private static void onAddReloadListener(AddReloadListenerEvent event) {
        ...
        DataDrivenDamageModifierProfileApi.onAddReloadListener(event);
        DataDrivenTrackedValueApi.onAddReloadListener(event);
        DataDrivenTrackedValueRuleApi.onAddReloadListener(event);
    }

    private static void onDatapackSync(OnDatapackSyncEvent event) {
        RecipePermissionApi.onDatapackSync(event);
        DataDrivenDefinitionSyncPayload payload = DataDrivenDefinitionSyncPayload.createCurrent();
